...
class ConditionalLSTM(nn.Module):
    def __init__(self, input_size_x, input_size_v, hidden_size, output_size):
    ...
    def forward(self, x, v):
        ...
        encoded_x = torch.tanh(self.encoder_x(x))  # Using tanh activation
...
class ConditionalGRU(nn.Module):
    ...
    def forward(self, x, v):
        ...
        encoded_x = torch.tanh(self.encoder_x(x))
